...
class Pagination{
	...
	public static function showPager($link,&$page_no,$page_size,$row_count){
		...
		if ($page_no > 1){
			$navibar .= "<li><a href=\"$url?$params&page_no=1\">first page</a></li>\n <li><a href=\"$url?$params&page_no=".($page_no-1)." \">previous page</a></li>\n";
		}
		...
		if ($page_no < $total_page){
			$navibar .= "<li><a href=\"$url?$params&page_no=".($page_no+1)."\">next page</a></li>\n <li><a href=\"$url?$params&page_no=$total_page\">last page</a></li>\n ";
		}
		if($total_page>0){
			$navibar.="<li><a>".$page_no ."/". $total_page."</a></li>";
		}
		$navibar.="<li><a>total:".$row_count."</a></li>";
		$jump ="";
